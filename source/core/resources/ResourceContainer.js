...
ResourceContainer.prototype.getTexture = function(uuid)
{
	...
	{
		console.warn("iStudio: ResourceContainer, Undefined texture", uuid);
	}
...
ResourceContainer.prototype.getGeometry = function(uuid)
{
	...
	{
		console.warn("iStudio: ResourceContainer, Undefined geometry", uuid);
	}
...
ResourceContainer.prototype.getMaterial = function(uuid)
{
	if (uuid instanceof Array)
	{
		...
		for (var i = 0; i < uuid.length; i++)
		{
			...
			{
				console.warn("iStudio: ResourceContainer, Undefined material", uuid);
			}
...
ResourceContainer.prototype.getFont = function(uuid)
{
	...
	{
		console.warn("iStudio: ResourceContainer, Undefined font", uuid);
	}
...
ResourceContainer.prototype.getAudio = function(uuid)
{
	...
	{
		console.warn("iStudio: ResourceContainer, Undefined audio", uuid);
	}
